...
- **Tekstur & Palet Warna**: [Color grading dan kontras yang membuat gambar 'pop' di algoritma TikTok]`;
  ...
  app.post('/api/generate-content-ideas', async (req, res) => {
    ...
    try {
      ...
      const cacheInput = `content_ideas_v3_${mimeType}_${sampleData}_${model}_${contentType}_${tone}_${maxDuration}_${segmentDuration}_${targetAI}_${aeoQueryMode}_${enableBigSound}_${enableTextOverlay}_${refImgSample}_${userSeedSample}`;
      const cacheKey = crypto.createHash('sha256').update(cacheInput).digest('hex');
...
Hasilkan HANYA 1 paragraf padat berbahasa Inggris yang mendeskripsikan secara jelas ciri khas subjek/produk utama di gambar ini.`;
      ...
      // =========================================================================
      logger.info('[Content Ideas Stage 2] Menghasilkan 5 ide konten grounded...');
...
# 🚀 5 IDE KONTEN VIRAL & AEO ENGINE OPTIMIZED (${maxSecNum}s, ${expectedClipsCount} Klip)
...
- **AEO Query Mapping**: Short → [...], Long → [...]
- **Alasan Relevansi**: [...]
- **BLUFF Hook Pikat (0-3s)**: "[...]"
- **Atomic Answer Summary (LLM RAG Citation Ready)**: "[...]"
- **Consensus Trigger (Tier 2 Validation)**: "[...]"
